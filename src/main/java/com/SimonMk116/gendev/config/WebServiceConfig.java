...
/*
    ...
    public PoolingHttpClientConnectionManager connectionManager() {
        ...
        connectionManager.setMaxTotal(100); // Adjust as needed
        connectionManager.setDefaultMaxPerRoute(20); // Adjust as needed
    ...
    @Bean
    public WebServiceMessageSender messageSender(HttpClient httpClient) {
